...
- [x] **TODO-7: insert gstack `review` phase before `cso`** — Code-review pass with codex voice
  ...
  - **What:** Add a new phase between `phase_4_development` and `phase_6_1_cso` in `configs/phases.yaml` that runs the gstack `/review` (a.k.a. `code-review`) skill — with codex voice when applicable (`/code-review --voice codex` / `--codex`) — autofixes findings, and commits.ith codex voice
