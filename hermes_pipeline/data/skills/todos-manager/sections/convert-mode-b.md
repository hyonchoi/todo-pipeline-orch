...
11b. **Apply conversion on confirm:**
    ...
    - Converted active entries are written under `## Entries`; converted or preserved schema/reference text never goes under `## Entries` unless it is an actual TODO entry.
